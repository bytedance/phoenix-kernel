...
// Pico-Audio start: AUDIO_B00014: recording noise in start
#define BOLERO_CDC_VA_TX_DMIC_UNMUTE_DELAY_MS       240
#define BOLERO_CDC_VA_TX_AMIC_UNMUTE_DELAY_MS       300
#define BOLERO_CDC_VA_TX_DMIC_HPF_DELAY_MS       500
#define BOLERO_CDC_VA_TX_AMIC_HPF_DELAY_MS       500
// Pico-Audio end: AUDIO_B00014
