...
//Pico-Auido: bringup analog headset {@
#define WCD_MBHC_ADC_HS_THRESHOLD_MV    1795 //phoenix:1795; origin:1800
#define WCD_MBHC_ADC_HPH_THRESHOLD_MV   50   //phoenix:50; origin:75
//Pico-Audio: @}
...
enable_supply:
	...
	/* Pico-Audio:
	* MICBIAS2 is normally open as the signal source for key detection,
	* and the 100uA current source is turned off at the same time. {@
	*/
	if (plug_type == MBHC_PLUG_TYPE_HEADSET) {
		mbhc->micbias_enable = true;
	}
