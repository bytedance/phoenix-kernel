...
TASK_PFA_TEST(KGSL_CTX_PRIORITY_MAX, kgsl_ctx_priority_max)
TASK_PFA_SET(KGSL_CTX_PRIORITY_MAX, kgsl_ctx_priority_max)
TASK_PFA_CLEAR(KGSL_CTX_PRIORITY_MAX, kgsl_ctx_priority_max)
TASK_PFA_TEST(KGSL_CTX_PRIORITY_HIGH, kgsl_ctx_priority_high)
TASK_PFA_SET(KGSL_CTX_PRIORITY_HIGH, kgsl_ctx_priority_high)
TASK_PFA_CLEAR(KGSL_CTX_PRIORITY_HIGH, kgsl_ctx_priority_high)
