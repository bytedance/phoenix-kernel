...
struct kgsl_device {
	...
	/*detect overclock whether or not to be supportted*/
	bool gpu_overclock_support;
	/*set overclock mode, disable for default*/
	bool gpu_overclock_mode;
	/*detect notmal pwrlevel,if overclock is support*/
	unsigned int gpu_normal_pwrlevel;
#endif
};
