...
#define FLASHLIGHT_MAGIC 'A'
#define FLASH_IOC_SET_TIME_OUT_TIME_MS _IOWR(FLASHLIGHT_MAGIC, 100, struct flashlight_dev_arg)
#define FLASH_IOC_SET_DUTY	_IOWR(FLASHLIGHT_MAGIC, 110, struct flashlight_dev_arg)
#define	FLASH_IOC_SET_ONOFF	_IOWR(FLASHLIGHT_MAGIC, 115, struct flashlight_dev_arg)
#define FLASH_IOC_SET_BLINK_OFF_TIMEOUT	_IOWR(FLASHLIGHT_MAGIC, 116, struct flashlight_dev_arg)
#define FLASH_IOC_STROBE_SET	_IOWR(FLASHLIGHT_MAGIC, 117, struct flashlight_gpioctl_arg)
...
/* aw36429 chip data */
struct aw36429_chip_data {
	struct i2c_client *client;
	struct aw36429_platform_data *pdata;
	struct mutex lock;
	u8 last_flag;
	u8 no_pdata;
