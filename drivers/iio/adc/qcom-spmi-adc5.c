...
static const struct adc_channels adc_chans_pmic5[ADC_MAX_CHANNEL] = {
	...
	[ADC_GPIO4_PU2]	= ADC_CHAN_TEMP("gpio4_pu2", 1,
					SCALE_HW_CALIB_THERM_100K_PULLUP)
	/*added by clark.tian for bug 59911 :camera temp report--start*/
	[ADC_GPIO1_PU2]	= ADC_CHAN_TEMP("gpio5_temp", 1,
					SCALE_HW_CALIB_THERM_100K_PULLUP)
	/*added by clark.tian for bug 58990 :ipd debug--start*/
	//GPIO7 IPD
	//[ADC_GPIO3_PU1] = ADC_CHAN_VOLT("gpio7C_v", 1,
	//				SCALE_HW_CALIB_DEFAULT)
	//GPIO7 CAM_TEMP
	[ADC_GPIO3_PU2] = ADC_CHAN_TEMP("gpio7C_v", 1,
					SCALE_HW_CALIB_THERM_100K_PULLUP)
	/*added by clark.tian for bug 58990 :ipd debug--end*/
	[ADC_AMUX_THM1_PU2] = ADC_CHAN_TEMP("amux1_temp", 1,
					SCALE_HW_CALIB_THERM_100K_PULLUP)
	[ADC_AMUX_THM3_PU2] = ADC_CHAN_TEMP("amux3_temp", 1,
					SCALE_HW_CALIB_THERM_100K_PULLUP)
	[ADC_AMUX_THM4] = ADC_CHAN_VOLT("gpio1C_v", 1,
					SCALE_HW_CALIB_DEFAULT)
	/*added by clark.tian for bug 59911 :camera temp report--end*/
};
