...
//PicoBSP: Alex_ma add for offlinedump -->start
extern ssize_t show_offline_dump_enable(struct kobject *kobj, struct attribute *attr,char *buf);
extern size_t store_offline_dump_enable(struct kobject *kobj, struct attribute *attr,const char *buf, size_t count);
RESET_ATTR(offline_dump_enable, 0644, show_offline_dump_enable, store_offline_dump_enable);
...
#endif
//PicoBSP: Alex_ma add for offlinedump -->start
	&reset_attr_offline_dump_enable.attr,
