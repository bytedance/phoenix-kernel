...
set_jeita_fv:
	/* Added by gavin.zhao for task_68794 speed up charging  --begin */
	rc = power_supply_get_property(chip->batt_psy,
				POWER_SUPPLY_PROP_CURRENT_NOW, &pval);
	if(fv_uv == 4400000){
		if(pval.intval >= 2500000)
			fv_uv = 4460000;
		else if((pval.intval < 2500000) && (pval.intval >= 2250000))
			fv_uv = 4454000;
		else if((pval.intval < 2250000) && (pval.intval >= 2000000))
			fv_uv = 4448000;
		else if((pval.intval < 2000000) && (pval.intval >= 1750000))
			fv_uv = 4442000;
		else if((pval.intval < 1750000) && (pval.intval >= 1500000))
			fv_uv = 4436000;
		else if((pval.intval < 1500000) && (pval.intval >= 1250000))
			fv_uv = 4430000;
		else if((pval.intval < 1250000) && (pval.intval >= 1000000))
			fv_uv = 4424000;
		else if((pval.intval < 1000000) && (pval.intval >= 750000))
			fv_uv = 4418000;
		else if((pval.intval < 750000) && (pval.intval >= 500000))
			fv_uv = 4412000;
		else if((pval.intval < 500000) && (pval.intval >= 250000))
			fv_uv = 4406000;
		else
			fv_uv = 4400000;
	}
	...
	/* Added by gavin.zhao for task_68794 speed up charging  --end */
