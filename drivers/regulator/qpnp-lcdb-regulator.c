...
static int qpnp_lcdb_hw_init(struct qpnp_lcdb *lcdb)
{
	...
	/* Added by gavin.zhao for delay 8/4ms between ncp and ldo ---begin */
	qpnp_lcdb_secure_write(lcdb, lcdb->base + LCDB_PWRUP_PWRDN_CTL_REG, 0x0e);
	/* Added by gavin.zhao for delay 8/4ms between ncp and ldo ---end */
