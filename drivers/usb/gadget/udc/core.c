...
/* ------------------------------------------------------------------------- */
/*Add by PICO_Driver sophia.wang for bug25650 : add USB insert state cable_orientation in androido start--*/
#include <linux/gpio.h>

static ssize_t show_usb_cable_orientation(struct device *dev,
		struct device_attribute *attr, char *buf)
{
    u8 cable_dir = 0;//usb Cable orientation.

    cable_dir = gpio_get_value(1165);
    return sprintf(buf, "%d\n",cable_dir);
}
static DEVICE_ATTR(usb_cable_orientation, S_IRUGO | S_IWUSR | S_IWGRP, show_usb_cable_orientation, NULL);
/*Add by PICO_Driver sophia.wang for bug25650 : add USB insert state cable_orientation in androido end--*/
...
static struct attribute *usb_udc_attrs[] = {
	...
	&dev_attr_usb_cable_orientation.attr,/*Add by PICO_Driver sophia.wang for bug25650 : add USB insert state cable_orientation in androido --*/
	NULL,
};
