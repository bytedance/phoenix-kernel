...
#define PFA_KGSL_CTX_PRIORITY_MAX        7
#define PFA_KGSL_CTX_PRIORITY_HIGH       8
...
extern int sched_save_priority_and_promote(struct sched_attr *attr);
extern int sched_restore_priority(struct sched_attr *attr);
