...
static void cam_req_mgr_process_workq_link_worker(struct kthread_work *w)
{
	cam_req_mgr_process_workq_usingkthread(w);
}
#else
...
#ifdef __CAMERA_EDITOR__
	/*Add by liubo.leoliu @ pico camera, 20220727, using kthread worker with prio to instead workqueue tasks*/
	rc = cam_req_mgr_workq_create_usingkthread(buf, CRM_WORKQ_NUM_TASKS,
